...
name_arr = ['resnet50', 'cifar10', 'last{}'.format(5), 'split{}'.format(0.01)]
...
remaining_dataset, forget_dataset = split_user_train_dataset_to_remaining_forget('cifar10', 'resnet50', 0.01)

...
def train_user_data(arch_id, dataset_id, number_of_linearized_components,
                    batch_size, use_default=True, pretrained_model_path=None,
                    device_id=0, shuffle=True):
    ...
    for epoch in range(50):
        ...
        running_train_acc, checkpoint = train_accuracy_mixed_linear(mixed_linear_model, user_train_loader, feature_model,
                                                                    ...
                                                                    checkpoint)
        mixed_linear_model, optimizer, scheduler, running_loss, checkpoint = train_mixed_linear(mixed_linear_model, user_test_loader,

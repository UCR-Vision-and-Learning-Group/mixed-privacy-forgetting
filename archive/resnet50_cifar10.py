...
folder_name_exp = '{}-resnet50-cifar10'.format(folder_name_datetime)
file_name_exp = '{}_resnet50_cifar10'.format(file_name_datetime)
...
feature_backbone = nn.Sequential(*kid_arr[:-3])
freeze(feature_backbone)
feature_backbone = feature_backbone.to(device)


linearized_head_core = kid_arr[-3:]
linearized_head_core.insert(2, Flatten())
